		...
		<div class="row -post-entry single-entry">
			<article class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0">
				...
				<div class="col-lg-12 col-lg-offset-0 col-md-12 col-md-offset-0 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-left content-article">
					...
					<div class="col-lg-4 animate-box">
							<div class="-highlight right">
								<h4>Vote this content!</h4>
								<div class="field-wrap">
          					<button disabled=”disabled” class="button" type=submit>
          					<img src="images/stella.png" width=”0″ height=”0″ title=”invia adesso” border=”0″ vspace=”0″ alt=”invia” align=”center”>  
          					</button>

          					<button disabled=”disabled” class="button" type=submit>
          					<img src="images/stella.png" width=”0″ height=”0″ title=”invia adesso” border=”0″ vspace=”0″ alt=”invia” align=””>  
          					</button>
					...
					<form action="/Project/myFavourite" method = "get">
          			...
          			<!-- pulsante per admin -->
          				<div class="field-wrap">
          					<button disabled=”disabled” class="button" type=submit>Edit!</button> 
          				</div> 
					<div class="row rp-b">
