		...
		<div class="row -post-entry">
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>	<!-- qui è il tag di cambio pagina -->
					<a href="news.html"><img src="images/news.png" alt="Image" class="img-responsive"></a>
				</figure>
				<span class="-meta"><a href="single.html">News</a></span>
			...
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="filmpage.html"><img src="images/film.jpg" alt="Image" class="img-responsive"></a>
				</figure>
			...
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="seriepage.html"><img src="images/serie.jpg" alt="Image" class="img-responsive"></a>
				</figure>
			...
			<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box">
				<figure>
					<a href="single.html"><img src="images/amici.jpg" alt="Image" class="img-responsive"></a>
				</figure>
